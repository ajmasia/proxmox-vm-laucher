...
# 2. Bump version in tauri.conf.json and package.json
# (edit files)
...
❌ **DON'T**:
- Include references to AI tools or assistants
- Use past tense ("added", "fixed")
- Be vague ("update stuff", "fix things")
- Include emojis in commit messages (only in release notes)
...
- **`main`** - Requires pull request reviews (configured on GitHub)
